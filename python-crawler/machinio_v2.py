...
urls = ["https://www.machinio.com/backhoe-loaders/united-states.json?page=1&format=json",
...
for url in urls:
    ...
    temp = re.sub('[\d]', '#', url)
    startNum = 1
    endNum = math.ceil(int(requestTime+1)/3)
    '''
    int(requestTime+2)'''
...
df.to_csv("machinio_p1.csv", sep=',', encoding='utf-8')